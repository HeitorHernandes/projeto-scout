...
- **Scout_Desempenho** — desempenho individual de um jogador em uma partida (gols, assistências, passes, desarmes, cartões etc.)
...
- Adicionar queries analíticas (artilheiros, aproveitamento de passes por jogador)
- Implementar logging no lugar dos prints
